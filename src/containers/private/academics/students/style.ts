...
export const AcademicStudentListingMain = styled.div`
  width: 100%;
  display: flex;
...
export const AcademicStudentListingSection = styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 1.5em;
...
export const AcademicStudentListingTop = styled.div`
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: space-between;
