...
export const AcademicStudentClearanceListingMain = styled.div`
  width: 100%;
  display: flex;
...
export const AcademicStudentClearanceListingSection = styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 1.5em;
...
export const AcademicStudentClearanceListingTop = styled.div`
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: space-between;
