...
export const AcademicDeafaulterStudentMain = styled.div`
  width: 100%;
  display: flex;
...
export const AcademicDeafaulterStudentSection = styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 1.5em;
...
export const AcademicDeafaulterStudentTop = styled.div`
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: space-between;
