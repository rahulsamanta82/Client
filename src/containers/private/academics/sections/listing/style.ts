...
export const AcademicSectionsListingMain = styled.div`
  width: 100%;
  display: flex;
...
`;
export const AcademicSectionsListingTop = styled.div`
  width: 100%;
  display: flex;
  align-items: center;
...
export const AcademicSectionsListingSection = styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 1.5em;
