...
export const AcademicPaidVouchersListingMain = styled.div`
  width: 100%;
  display: flex;
...
export const AcademicPaidVouchersListingSection = styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 1.5em;
...
export const AcademicPaidVouchersListingTop = styled.div`
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: space-between;
