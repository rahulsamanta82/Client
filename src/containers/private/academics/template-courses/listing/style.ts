...
export const AcademicTemplateCoursesListingMain = styled.div`
  width: 100%;
  display: flex;
...
export const AcademicTemplateCoursesListingSection = styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 1.5em;
...
export const AcademicTemplateCoursesListingTop = styled.div`
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: space-between;
