...
export const ApprovedReceiptAcknowledgedListingMain = styled.div`
  width: 100%;
  display: flex;
...
export const ApprovedReceiptAcknowledgedListingSection = styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 1.5em;
...
export const ApprovedReceiptAcknowledgedListingTop = styled.div`
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: space-between;
