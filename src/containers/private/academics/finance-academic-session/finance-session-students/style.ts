...
export const FinanceSessionStudentsListingMain = styled.div`
  width: 100%;
  display: flex;
...
export const FinanceSessionStudentsListingSection = styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 1.5em;
...
export const FinanceSessionStudentsListingTop = styled.div`
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: space-between;
