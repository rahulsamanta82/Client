...
const AcademicCourseGroupsListing: FC<AcademicCourseGroupsListingProps> = ({ }) => {
    ...
    const goToCreateAcademicCourseGroup = () => {
        navigate(siteRoutes.createAcademicCourseGroup);
    };
    ...
    return (
        <AcademicCourseGroupsListingMain>
            <AcademicCourseGroupsListingTop>
                <div className="left">
                    <span className="page-heading">Course Groups</span>
                    <Breadcrumb links={breadcrumbLinks} />
                </div>
                <div className="right">
                    {hasAccess(sitePermissions.createAcademicCourse) && (
                        <div className="create-fine-slot-btn">
                            <button className="lg-rounded-btn" onClick={goToCreateAcademicCourseGroup}>
                                + Add Course Group
                            </button>
                        </div>
                    )}
                                    ...
                                    <tr key={index}>
                                        <td>
                                            <div className="mw-150">
                                                PS-401 Pakistan Study (Biochemistry)
                                            </div>
                                        </td>
                                        <td>Merge</td>
                                        <td>
...
export default AcademicCourseGroupsListing;
