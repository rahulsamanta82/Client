...
export const AcademicFeeTypeListingMain = styled.div`
  width: 100%;
  display: flex;
...
export const AcademicFeeTypeListingSection = styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 1.5em;
...
export const AcademicFeeTypeListingTop = styled.div`
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: space-between;
