...
interface AddCareerQualificationProps {
  setOpen: Function;
  qualification: any;
}

const AddCareerQualification: FC<AddCareerQualificationProps> = ({ setOpen, qualification }) => {
...
export default AddCareerQualification;
