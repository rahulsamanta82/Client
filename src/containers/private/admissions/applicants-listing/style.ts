...
export const AdmissionApplicantsListingMain = styled.div`
  width: 100%;
  display: flex;
...
export const AdmissionApplicantsListingSection = styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 1.5em;
...
export const AdmissionApplicantsListingTop = styled.div`
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: space-between;
