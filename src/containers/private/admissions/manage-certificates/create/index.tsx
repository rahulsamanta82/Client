...
const CreateAdmissionCertificateManagement: FC<
  AdmissionStudentListingProps
> = () => {
      ...
      <CertificateManagementCreateTop>
        <div className="left">
          <span className="page-heading">
            {params?.id ? "Update" : "Add"} Certificate /Degree
          </span>
          <Breadcrumb />
        </div>
      </CertificateManagementCreateTop>
          ...
          <div className="common-fields">
            ...
            <div className="input-field">
              ...
              <div className="field-wrap">
                <div className="field">
                  <select name="" id="">
                    <option value="">Select Certificate Levels</option>
                    {certificateLevels.map((item: any) => {
...
export default CreateAdmissionCertificateManagement;
