...
const CreateAdmissionTestTypes: FC<EditAdmissionDocumentProps> = () => {
  ...
  useEffect(() => {
      if(params?.id) getAdmissionEntryTestById(params?.id, formData, setValue, setFormData);
  }, []);
    ...
    <EditAdmissionDocumentMain>
      <EditAdmissionDocumentTop>
        <div className="heading">
          <span className="page-heading">{params?.id ? 'Update' : 'Add'} Test Type</span>
          <Breadcrumb />
        </div>
      </EditAdmissionDocumentTop>
...
export default CreateAdmissionTestTypes;
