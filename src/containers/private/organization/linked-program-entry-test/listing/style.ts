...
export const LinkedProgramsEntryTestListingMain = styled.div`
  width: 100%;
  display: flex;
...
export const LinkedProgramsEntryTestListingSection = styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 1.5em;
...
export const LinkedProgramsEntryTestListingTop = styled.div`
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: space-between;
