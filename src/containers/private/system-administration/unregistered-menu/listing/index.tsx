...
const UnregisteredMenusListing: FC = () => {
  ...
  return (
    <MenusListingMain>
      <MenusListingTop>
        <div className="left">
          <span className="page-heading">Unregistered Menu</span>
          <Breadcrumb />
        </div>
        <div className="right">
          ...
          <table className="bottom-bordered-cells">
            ...
            <tbody>
              <tr>
                ...
                <td>Examination</td>
                <td>Search Bill</td>
                <td>my/application/controller/check.php </td>
...
export default UnregisteredMenusListing;
