...
export const OvertimeManualEntryListingMain = styled.div`
  width: 100%;
  display: flex;
...
export const OvertimeManualEntryListingSection = styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 1.5em;
...
export const OvertimeManualEntryListingTop = styled.div`
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: space-between;
