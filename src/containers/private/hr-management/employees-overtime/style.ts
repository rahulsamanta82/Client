...
export const EmployeesOvertimeListingMain = styled.div`
  width: 100%;
  display: flex;
...
export const EmployeesOvertimeListingSection = styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 1.5em;
...
export const EmployeesOvertimeListingTop = styled.div`
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: space-between;
