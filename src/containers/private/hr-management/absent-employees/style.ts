...
export const AbsentEmployeesListingMain = styled.div`
  width: 100%;
  display: flex;
...
export const AbsentEmployeesListingSection = styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 1.5em;
...
export const AbsentEmployeesListingTop = styled.div`
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: space-between;
