...
export const EmployeesAttendanceListingMain = styled.div`
  width: 100%;
  display: flex;
...
export const EmployeesAttendanceListingSection = styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 1.5em;
...
export const EmployeesAttendanceListingTop = styled.div`
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: space-between;
